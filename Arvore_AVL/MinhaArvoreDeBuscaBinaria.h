...
class MinhaArvoreDeBuscaBinaria : public ArvoreDeBuscaBinaria<T>{
    ...
    void inserir_rec(T chave, Nodo<T>* root){
        int alt_atual = 1;
        ...
        if(root == nullptr){
            ...
            if(root->chave > chave){
                ...
                inserir_rec(chave, root->filhoEsquerda);
                alt_atual = root->filhoEsquerda->altura + 1;
                }else{
                ...
                inserir_rec(chave, root->filhoDireita);
                alt_atual = root->filhoDireita->altura + 1;
                }else{
